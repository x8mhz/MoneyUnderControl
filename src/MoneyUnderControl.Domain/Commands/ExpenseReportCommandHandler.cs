...
namespace MoneyUnderControl.Domain.Commands
{
        ...
        IRequestHandler<RemoveExpenseReportCommand, ValidationResult>
    {
        ...
        {
            var expense = new ExpenseReport(Guid.NewGuid(), request.Item, request.Price, request.ExpenseDate, request.Category);
        ...
        {
            var expense = new ExpenseReport(request.Id, request.Item, request.Price, request.ExpenseDate, request.Category);
